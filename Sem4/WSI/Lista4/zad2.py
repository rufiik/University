...
N = 60000  # rozmiar próbki (cały zbiór: 70000, próbka np. 5000)
eps = 1480
min_samples = 5
# ---------------------------------
...
print(f"eps={eps}, min_samples={min_samples}: liczba klastrów={n_clusters}, szum={n_noise/len(labels)*100:.2f}%")
