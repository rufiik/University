...
class CWrapper:
    ...
    def __init__(self, lib_path: str = "../../C/libmathC.so"):
        if not os.path.exists(lib_path):
            lib_path = "./libmathC.so"
    ...
    def _setup_functions(self):
        ...
        class DiophantineSolutionStruct(ctypes.Structure):
            _fields_ = [
        ...
        self.DiophantineSolutionStruct = DiophantineSolutionStruct
        self.lib.solve_linear_diophantine.argtypes = [
            ctypes.c_uint64, ctypes.c_uint64, ctypes.c_uint64
        ]
        self.lib.solve_linear_diophantine.restype = DiophantineSolutionStruct
